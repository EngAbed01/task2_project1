      ...
      <div class="row">
        ...
        <div class="col-lg-8 entries">
          ...
          <article class="entry entry-single">
            <div class="entry-img">
              <img src="{{ asset('moderna/assets/img/blog-post-1.jpg') }}" alt="" class="img-fluid">
            </div>
            ...
            <div class="entry-content">
              ...
              <img src="{{ asset('moderna/assets/img/blog-post-4.jpg') }}" class="img-fluid" alt="">
          ...
          <div class="blog-author clearfix">
            <img src="{{ asset('moderna/assets/img/blog-author.jpg') }}" class="rounded-circle float-left" alt="">
            <h4>Jane Smith</h4>
          ...
          <div class="blog-comments">
            ...
            <div id="comment-1" class="comment clearfix">
              <img src="{{ asset('moderna/assets/img/comments-1.jpg') }}" class="comment-img  float-left" alt="">
            ...
            <div id="comment-2" class="comment clearfix">
              <img src="{{ asset('moderna/assets/img/comments-2.jpg') }}" class="comment-img  float-left" alt="">
              ...
              <div id="comment-reply-1" class="comment comment-reply clearfix">
                <img src="{{ asset('moderna/assets/img/comments-3.jpg') }}" class="comment-img  float-left" alt="">
                ...
                <div id="comment-reply-2" class="comment comment-reply clearfix">
                  <img src="{{ asset('moderna/assets/img/comments-4.jpg') }}" class="comment-img  float-left" alt="">
            ...
            <div id="comment-3" class="comment clearfix">
              <img src="{{ asset('moderna/assets/img/comments-5.jpg') }}" class="comment-img  float-left" alt="">
            ...
            <div id="comment-4" class="comment clearfix">
              <img src="{{ asset('moderna/assets/img/comments-6.jpg') }}" class="comment-img  float-left" alt="">
          ...
          <div class="sidebar">
            ...
            <div class="sidebar-item recent-posts">
              <div class="post-item clearfix">
                <img src="{{ asset('moderna/assets/img/recent-posts-1.jpg') }}" alt="">
                <h4><a href="blog-single.html">Nihil blanditiis at in nihil autem</a></h4>
                <time datetime="2020-01-01">Jan 1, 2020</time>
              </div>

              <div class="post-item clearfix">
                <img src="{{ asset('moderna/assets/img/recent-posts-2.jpg') }}" alt="">
                <h4><a href="blog-single.html">Quidem autem et impedit</a></h4>
                <time datetime="2020-01-01">Jan 1, 2020</time>
              </div>

              <div class="post-item clearfix">
                <img src="{{ asset('moderna/assets/img/recent-posts-3.jpg') }}" alt="">
                <h4><a href="blog-single.html">Id quia et et ut maxime similique occaecati ut</a></h4>
                <time datetime="2020-01-01">Jan 1, 2020</time>
              </div>

              <div class="post-item clearfix">
                <img src="{{ asset('moderna/assets/img/recent-posts-4.jpg') }}" alt="">
                <h4><a href="blog-single.html">Laborum corporis quo dara net para</a></h4>
                <time datetime="2020-01-01">Jan 1, 2020</time>
              </div>

              <div class="post-item clearfix">
                <img src="{{ asset('moderna/assets/img/recent-posts-5.jpg') }}" alt="">
