...
<head>
  ...
  <title>Moderna Bootstrap Template - @yield('title')</title>
  <meta content="" name="descriptison">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="{{ asset('moderna/assets/img/favicon.png') }}" rel="icon">
  ...
  <header id="header" class="fixed-top header-transparent">
    <div class="container">
      ...
      <div class="logo float-left">
        <h1 class="text-light"><a href="{{ route('app.home') }}"><span>Moderna</span></a></h1>
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li><a href="{{ route('app.services') }}">Services</a></li>
          <li><a href="{{ route('app.portfolio') }}">Portfolio</a></li>
          <li><a href="{{ route('app.team') }}">Team</a></li>
