        ...
        <div class="col-lg-8 entries">
          ...
          <article class="entry">
            ...
            <h2 class="entry-title">
              <a href="{{ route('app.blog.blog-single') }}">Dolorum optio tempore voluptas dignissimos cumque fuga qui quibusdam quia
                reiciendis</a>
            </h2>
          ...
          <article class="entry">
            ...
            <div class="entry-img">
              <img src="{{ asset('moderna/assets/img/blog-post-2.jpg') }}" alt="" class="img-fluid">
            </div>
          ...
          <article class="entry">
            ...
            <div class="entry-img">
              <img src="{{ asset('moderna/assets/img/blog-post-3.jpg') }}" alt="" class="img-fluid">
            </div>
          ...
          <article class="entry">
            ...
            <div class="entry-img">
              <img src="{{ asset('moderna/assets/img/blog-post-4.jpg') }}" alt="" class="img-fluid">
            </div>
